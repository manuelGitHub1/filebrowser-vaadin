...
import de.mbr.manuel.ui.views.categorieslist.CategoriesList;
import de.mbr.manuel.ui.views.reviewslist.FileList;
...
public class MainLayout extends Div
    ...
    public MainLayout() {
        H2 title = new H2("File Browser");
        title.addClassName("main-layout__title");

        RouterLink reviews = new RouterLink(null, FileList.class);
        reviews.add(new Icon(VaadinIcon.LIST), new Text("Files"));
